...
this may have something to do with your script execution order. Ideeally character controller platformer would run after whatever's making it jump in the script execution order.
